...
import static com.convertx2x.office2md.drawing.DrawingScene.Kind;
    ...
    private static final class Reader {
        ...
        private void read(Shape shape, AffineTransform parent, boolean child, boolean knownPosition,
            ...
            if (shape instanceof XSSFShapeGroup group) {
                ...
                if (offset == null || extent == null || width <= 0 || height <= 0) {
                    known = false;
        ...
        private void readShape(Shape shape, Node xml, DrawingScene.Item item, boolean textFlipped) {
            ...
            if (shape instanceof XSSFGraphicFrame) {
                item.typeName = DrawingAltText.typeName("graphicFrame");
            ...
            if (shape instanceof XSSFSimpleShape simple && !(shape instanceof org.apache.poi.ss.usermodel.ObjectData)) {
                ...
                item.typeName = DrawingAltText.typeName(shape instanceof XSSFTextBox ? "textBox"
                        : geometry.isEmpty() && child(properties, "custGeom") != null ? "custGeom" : geometry);
                ...
                Node properties = child(xml, "spPr");
                String geometry = attr(child(properties, "prstGeom"), "prst");
                item.typeName = DrawingAltText.typeName(geometry);
                ...
                item.typeName = DrawingAltText.typeName(item.kind == Kind.UNSUPPORTED ? "HSSF:" + simple.getShapeType() : item.kind.name());
                ...
                if (simple instanceof HSSFTextbox textbox) {
                    ...
                    item.typeName = DrawingAltText.typeName("textBox");
                }
